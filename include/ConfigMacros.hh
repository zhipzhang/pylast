...
#define CONFIG_PARAM_CONSTRUCTORS(ClassType, ParamType, ParamName) \
    ClassType(ParamType ParamName): config::Configurable(), ParamName(ParamName) { setUp();  } \
    ClassType(ParamType ParamName, const json& config): \
        config::Configurable(config), ParamName(ParamName) { setUp();  } \
    ClassType(ParamType ParamName, const std::string& config_str): \
        config::Configurable(config_str, nullptr), ParamName(ParamName) { setUp();  } \
    ClassType(ParamType ParamName, const std::string& config_str, std::function<void(const std::string&)> callback): \
        config::Configurable(config_str, callback), ParamName(ParamName) { setUp();  }
...
#define CONFIG_DOUBLE_PARAM_CONSTRUCTORS(ClassType, ParamType1, ParamName1, ParamType2, ParamName2) \
    ClassType(ParamType1 ParamName1, ParamType2 ParamName2): \
        config::Configurable(), ParamName1(ParamName1), ParamName2(ParamName2) { setUp();  } \
    ClassType(ParamType1 ParamName1, ParamType2 ParamName2, const json& config): \
        config::Configurable(config), ParamName1(ParamName1), ParamName2(ParamName2) { setUp();  } \
    ClassType(ParamType1 ParamName1, ParamType2 ParamName2, const std::string& config_str): \
        config::Configurable(config_str, nullptr), ParamName1(ParamName1), ParamName2(ParamName2) { setUp();   } \
    ClassType(ParamType1 ParamName1, ParamType2 ParamName2, const std::string& config_str, \
              std::function<void(const std::string&)> callback): \
        config::Configurable(config_str, callback), ParamName1(ParamName1), ParamName2(ParamName2) { setUp();  }